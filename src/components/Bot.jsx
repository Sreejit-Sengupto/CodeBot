...
export default function Bot() {
  ...
  const url =
    "https://cheerful-nougat-4ccb49.netlify.app/.netlify/functions/fetchAI";
  ...
  return code ? (
    <MyCodeEditor displayText={code} setDisplayText={setCode} />
  ) : (
    <div className="bg-white w-[95%] lg:w-[40%] mx-auto mt-10 border-none rounded-xl flex flex-col items-center justify-center p-5">
      <div className="flex justify-center items-center">
        <img
          src="/images/robot.png"
          alt=""
          className=" w-60 ml-[-3rem] lg:w-72"
        />
      ...
      {loader ? (
        ...
        <div className="flex justify-center items-center mt-6">
          ...
          />
          <button
            className="w-28 p-[1.39rem] border-none rounded-lg bg-[#fe7f2d] rounded-tl-none rounded-bl-none font-Rubik text-xl text-white cursor-pointer"
            onClick={handleClick}
          >
            Ask
          </button>
